				...
				<div class="breadcrumb-contents">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Finance category</li>
						</ol>
					</nav>
				</div>
			</div>
								...
								<div class="product-card card-style-list">
									<div class="product-grid-content">
										<div class="product-header">
											...
											<h3><a href="product-details.php">7</a></h3>
										</div>
									...
									<div class="product-list-content">
										...
										<div class="product-card--body">
											...
											Faith
												...
												<h3><a href="product-details.php" tabindex="0">7 powerful ways</a></h3>
											</div>
											<article>
												<h2 class="sr-only">Card List Article</h2>
												<p>Getting into the supernatural.</p>
											</article>
											<div class="price-block">
												<span class="price">£51.20</span>
											</div>
									...
									<div class="product-list-content">
										...
										<div class="product-card--body">
											<div class="product-header">
												...
												<h3><a href="product-details.php" tabindex="0">Kids proclamation</a></h3>
											</div>
											<article>
												<h2 class="sr-only">Card List Article</h2>
												<p>Engage your children on daily proclamations of the word of God.</p>
											</article>
											<div class="price-block">
												<span class="price">£51.20</span>
											</div>
									...
									<div class="product-list-content">
										...
										<div class="product-card--body">
											<div class="product-header">
												...
												<h3><a href="product-details.php" tabindex="0">Proclamation</a></h3>
											</div>
											<article>
												<h2 class="sr-only">Card List Article</h2>
												<p>Proclaim daily the word of God and move with consciousness.</p>
											</article>
											<div class="price-block">
												<span class="price">£51.20</span>
											</div>
									...
									<div class="product-list-content">
										...
										<div class="product-card--body">
											<div class="product-header">
												...
												<h3><a href="product-details.php" tabindex="0">The Lost Presence</a></h3>
											</div>
											<article>
												<h2 class="sr-only">Card List Article</h2>
												<p>Getting back into the presence of God.</p>
											</article>
											<div class="price-block">
												<span class="price">£51.20</span>
											</div>
						...
						<div class="inner-page-sidebar">
							...
							<div class="single-block">
                                ...
                                <ul class="sidebar-menu--shop">
                                    ...
                                    <li><a href="#">Spiritual Growth and Maturity</a></li>
...
<!-- Mirrored from demo.hasthemes.com/pustok-preview/pustok/shop-list-left-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jan 2020 20:05:11 GMT -->
</html>